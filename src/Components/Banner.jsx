...
export default function Banner(){
    ...
    return(
        <div className={`flex justify-between items-center bg-neutral-800 text-white w-[100%] px-4 flex-row py-3 sticky top-0 z-30`}>
            ...
            <div><button className={`bg-yelloGreen p-2 text-sm text-black rounded-[0.5rem] shadow-sm shadow-yelloGreen`}>Download XTRA Theme</button></div>
